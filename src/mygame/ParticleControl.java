...
public class ParticleControl extends AbstractControl {
    ...
    ParticleControl(Vector3f velocity, float lifespan, ColorRGBA color, 
    ...
    protected void controlUpdate(float tpf) {
        ...
        alpha *= alpha;
        setAlpha(alpha);
        spatial.setLocalScale(0.3f + lesserValue(
                lesserValue(1.5f, 0.02f*speed+0.1f), alpha));
        spatial.scale(0.65f);
        ...
        // repel particles at game window boundaries
    ...
    public void applyGravity(Vector3f gravity, float distance) {
        Vector3f additionalVelocity = gravity.mult(1000f / 
                (distance*distance + 10000f));
